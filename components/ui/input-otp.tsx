/** biome-ignore-all lint/a11y/useFocusableInteractive: we need to use the focusable interactive elements */
/** biome-ignore-all lint/a11y/useAriaPropsForRole: we need to use the aria props for the role */
