...
function InputOTPSeparator({ ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useFocusableInteractive: we need to use a div here for the separator
    // biome-ignore lint/a11y/useSemanticElements: we need to use a div here for the separator
    <div
      data-slot="input-otp-separator"
      className="[&_svg:not([class*='size-'])]:size-4 flex items-center"
      // biome-ignore lint/a11y/useAriaPropsForRole: we need to use a role for the separator
      role="separator"
      {...props}
    >
