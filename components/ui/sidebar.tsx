/** biome-ignore-all lint/correctness/useExhaustiveDependencies: we need to use the exhaustive dependencies */
/** biome-ignore-all lint/suspicious/noDocumentCookie: we need to use the document cookie */
"use client";
